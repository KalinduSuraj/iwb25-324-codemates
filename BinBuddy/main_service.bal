    ...
    resource function post api/customer/login(http:Caller caller, http:Request req) returns error? {
        ...
        json response = {
            ...
            "data": {
                "customer_id": 123,
                "email": "customer@example.com",
                "session_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30",
                "profile": {
                    "full_name": "Sample Customer",
                    "phone": "+94701234567",
