-- BinBuddy Sample Data for Galle, Sri Lanka
-- Created: 2025-08-31
...
('admin.galle@binbuddy.lk', '$2a$10$hashedpassword1', 'admin', 'Galle Regional Manager', '+94912234567', TRUE),
('supervisor.galle@binbuddy.lk', '$2a$10$hashedpassword2', 'admin', 'Kamal Perera', '+94912234568', TRUE);

-- Customer Users (Galle residents)
INSERT INTO users (email, password, user_type, full_name, phone, is_active) VALUES
('nimal.silva@gmail.com', '$2a$10$hashedpassword3', 'customer', 'Nimal Silva', '+94701234567', TRUE),
('kumari.fernando@gmail.com', '$2a$10$hashedpassword4', 'customer', 'Kumari Fernando', '+94701234568', TRUE),
('asanka.rajapaksha@gmail.com', '$2a$10$hashedpassword5', 'customer', 'Asanka Rajapaksha', '+94701234569', TRUE),
('sandani.perera@gmail.com', '$2a$10$hashedpassword6', 'customer', 'Sandani Perera', '+94701234570', TRUE),
('rohan.wickramasinghe@gmail.com', '$2a$10$hashedpassword7', 'customer', 'Rohan Wickramasinghe', '+94701234571', TRUE),
('malini.gunasekara@gmail.com', '$2a$10$hashedpassword8', 'customer', 'Malini Gunasekara', '+94701234572', TRUE),
('chaminda.de.silva@gmail.com', '$2a$10$hashedpassword9', 'customer', 'Chaminda De Silva', '+94701234573', TRUE),
('priyanka.jayawardana@gmail.com', '$2a$10$hashedpassword10', 'customer', 'Priyanka Jayawardana', '+94701234574', TRUE),
('thilak.bandara@gmail.com', '$2a$10$hashedpassword11', 'customer', 'Thilak Bandara', '+94701234575', TRUE),
('menaka.wijesinghe@gmail.com', '$2a$10$hashedpassword12', 'customer', 'Menaka Wijesinghe', '+94701234576', TRUE);

-- Collector Users (Waste collectors in Galle)
INSERT INTO users (email, password, user_type, full_name, phone, is_active) VALUES
('sunil.collector@binbuddy.lk', '$2a$10$hashedpassword13', 'collector', 'Sunil Amarasinghe', '+94771234567', TRUE),
('lasith.collector@binbuddy.lk', '$2a$10$hashedpassword14', 'collector', 'Lasith Kumara', '+94771234568', TRUE),
('dinesh.collector@binbuddy.lk', '$2a$10$hashedpassword15', 'collector', 'Dinesh Madusanka', '+94771234569', TRUE),
('ranjan.collector@binbuddy.lk', '$2a$10$hashedpassword16', 'collector', 'Ranjan Dissanayake', '+94771234570', TRUE),
('gayan.collector@binbuddy.lk', '$2a$10$hashedpassword17', 'collector', 'Gayan Senaratne', '+94771234571', TRUE);
...
(13, 'Three Wheeler', 'CAK-1234', 'DL001234567', '["Galle Fort", "Kaluwella", "Dadalla", "Magalle"]', 6.0329, 80.2168, TRUE, 4.8, 156),

-- Collector 2: Unawatuna and coastal areas
(14, 'Small Truck', 'CAL-5678', 'DL001234568', '["Unawatuna", "Thalpe", "Koggala", "Ahangama"]', 6.0094, 80.2503, TRUE, 4.6, 203),

-- Collector 3: Hikkaduwa and northern areas
(15, 'Three Wheeler', 'CAM-9012', 'DL001234569', '["Hikkaduwa", "Dodanduwa", "Boossa", "Bentota"]', 6.1408, 80.1031, FALSE, 4.9, 289),

-- Collector 4: Southern Galle areas
(16, 'Motorcycle', 'CAN-3456', 'DL001234570', '["Habaraduwa", "Koggala", "Kataluwa", "Midigama"]', 5.9947, 80.3283, TRUE, 4.7, 134),

-- Collector 5: Central Galle areas
(17, 'Small Truck', 'CAP-7890', 'DL001234571', '["Galle City", "Wakwella", "Bope", "Poddala"]', 6.0535, 80.2210, TRUE, 4.5, 178);
...
(5, 5, 'Collection Accepted', 'Your waste collection request has been accepted by Sunil. Scheduled for today at 4:00 PM.', 'request_update', FALSE, '2025-08-31 09:15:00'),
(7, 6, 'Collector En Route', 'Lasith is on the way to your location. Estimated arrival: 5 minutes.', 'request_update', FALSE, '2025-08-31 12:55:00'),
(9, 8, 'New Request Submitted', 'Your immediate collection request has been submitted. Looking for available collectors in Hikkaduwa.', 'request_update', TRUE, '2025-08-31 14:15:00'),

-- Collector notifications
(13, 5, 'New Collection Request', 'New scheduled collection in Galle Fort area. Customer: Asanka Rajapaksha', 'request_update', TRUE, '2025-08-31 08:30:00'),
(14, 6, 'Collection Started', 'You have started collection for Rohan Wickramasinghe in Unawatuna.', 'request_update', TRUE, '2025-08-31 13:00:00'),
(15, NULL, 'Weekly Earnings Update', 'You earned Rs. 12,450 this week. Great job, Dinesh!', 'system', FALSE, '2025-08-31 06:00:00'),

-- System notifications
(3, NULL, 'Premium Subscription Benefits', 'Enjoy priority collection and 20% discount on all services!', 'promotion', FALSE, '2025-08-31 10:00:00'),
(8, NULL, 'Recycling Tips', 'Did you know? Proper waste segregation helps us serve you better!', 'system', TRUE, '2025-08-31 08:00:00');
...
-- Update collector total collections based on completed requests
UPDATE collector_profiles SET total_collections = (
    SELECT COUNT(*) FROM collection_requests 
    WHERE collector_id = collector_profiles.user_id AND status = 'completed'
);

-- Update collector ratings based on feedback
UPDATE collector_profiles SET rating = (
    SELECT COALESCE(AVG(rating), 0) FROM feedback 
    WHERE collector_id = collector_profiles.user_id
);

-- ==============================================
-- INDEXES FOR GALLE-SPECIFIC QUERIES
-- ==============================================

-- Geographic search index for Galle area
CREATE INDEX idx_customer_location_galle ON customer_profiles(latitude, longitude);
CREATE INDEX idx_collector_location_galle ON collector_profiles(current_latitude, current_longitude);
CREATE INDEX idx_requests_location_galle ON collection_requests(pickup_latitude, pickup_longitude);

-- Performance indexes for Galle operations
CREATE INDEX idx_requests_status_date ON collection_requests(status, scheduled_date);
...
-- ==============================================
/*
GALLE SAMPLE DATA INCLUDES:
- 2 Admin users (Regional manager and supervisor)
- 10 Customer users across major Galle areas
- 5 Collector users with different vehicle types
- 10 Collection requests (4 completed, 2 in-progress, 4 pending)
- Real-time tracking data for active collections
...
GEOGRAPHIC COVERAGE:
- Galle Fort (Historic area)
- Unawatuna (Beach area)
- Hikkaduwa (Tourist zone)
- Bentota (Coastal region)
- Koggala (Airport area)
- Ahangama (Southern coast)

REALISTIC FEATURES:
- Sri Lankan names and addresses
- Local phone number format (+94)
- Area-specific service zones
- Tourism-focused locations
- Proper GPS coordinates for Galle district
- Local currency (LKR) pricing
